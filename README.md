...
This project is a modified version of Point Pillar ([tyagi-iitiv/PointPillars](https://github.com/tyagi-iiitv/PointPillars)) using Tensorflow V2 with compat.v1 
